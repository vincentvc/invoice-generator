...
export function CorporatePreview({ invoice }: { invoice: InvoiceData }) {
    ...
    <div style={{ fontFamily: 'Inter, Arial, sans-serif', color: '#1A202C', fontSize: '1em', height: '100%' }}>
      ...
      <div style={{ backgroundColor: navy, color: '#FFFFFF', padding: '2em 3em', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <div style={{ textAlign: 'right' }}>
          <div style={{ fontSize: '1.8em', fontWeight: 800, letterSpacing: '0.08em' }}>INVOICE</div>
      ...
      <div style={{ padding: '2em 3em 3em' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '1.5em', marginBottom: '2em', paddingBottom: '1.5em', borderBottom: '2px solid #E2E8F0' }}>
          ...
          <div>
            ...
            <div style={{ fontSize: '0.85em', marginBottom: '0.3em' }}><strong>Issue Date:</strong> {invoice.issueDate ? new Date(invoice.issueDate).toLocaleDateString() : '-'}</div>
            <div style={{ fontSize: '0.85em', marginBottom: '0.3em' }}><strong>Due Date:</strong> {invoice.dueDate ? new Date(invoice.dueDate).toLocaleDateString() : '-'}</div>
            {invoice.paymentTerms && <div style={{ fontSize: '0.85em', marginBottom: '0.3em' }}><strong>Terms:</strong> {invoice.paymentTerms}</div>}
            {invoice.poNumber && <div style={{ fontSize: '0.85em' }}><strong>PO #:</strong> {invoice.poNumber}</div>}
          </div>
          <div />
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: invoice.hasShipTo ? '1fr 1fr' : '1fr', gap: '2em', marginBottom: '2em' }}>
          <div style={{ border: '1px solid #E2E8F0', padding: '1.2em', backgroundColor: '#F7FAFC' }}>
            <div style={{ fontSize: '0.72em', fontWeight: 600, textTransform: 'uppercase', color: navy, letterSpacing: '0.08em', marginBottom: '0.5em' }}>Bill To</div>
          ...
          {invoice.hasShipTo && (
            <div style={{ border: '1px solid #E2E8F0', padding: '1.2em', backgroundColor: '#F7FAFC' }}>
              <div style={{ fontSize: '0.72em', fontWeight: 600, textTransform: 'uppercase', color: navy, letterSpacing: '0.08em', marginBottom: '0.5em' }}>Ship To</div>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: '2em', border: '1px solid #CBD5E0' }}>
          <thead>
            <tr style={{ backgroundColor: navy, color: '#FFFFFF' }}>
              <th style={{ padding: '0.7em 1em', textAlign: 'left', fontSize: '0.78em', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.05em', borderRight: '1px solid ' + navyLight }}>Description</th>
              <th style={{ padding: '0.7em 1em', textAlign: 'center', fontSize: '0.78em', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.05em', borderRight: '1px solid ' + navyLight }}>Qty</th>
              <th style={{ padding: '0.7em 1em', textAlign: 'right', fontSize: '0.78em', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.05em', borderRight: '1px solid ' + navyLight }}>Rate</th>
              <th style={{ padding: '0.7em 1em', textAlign: 'right', fontSize: '0.78em', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.05em' }}>Amount</th>
            </tr>
          </thead>
          <tbody>
        ...
        {(invoice.notes || invoice.terms) && (
          <div style={{ marginTop: '2.5em', display: 'flex', gap: '2em' }}>
            {invoice.notes && (
              <div style={{ flex: 1 }}>
                <div style={{ fontSize: '0.72em', fontWeight: 600, textTransform: 'uppercase', color: navy, letterSpacing: '0.08em', marginBottom: '0.4em' }}>Notes</div>
                <div style={{ fontSize: '0.82em', color: '#4A5568', whiteSpace: 'pre-line' }}>{invoice.notes}</div>
              </div>
            )}
            {invoice.terms && (
              <div style={{ flex: 1 }}>
                <div style={{ fontSize: '0.72em', fontWeight: 600, textTransform: 'uppercase', color: navy, letterSpacing: '0.08em', marginBottom: '0.4em' }}>Terms & Conditions</div>
